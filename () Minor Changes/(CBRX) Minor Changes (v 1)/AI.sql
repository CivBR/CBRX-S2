...
BEGIN
UPDATE Leaders
SET WonderCompetitiveness = (WonderCompetitiveness + 2), MinorCivCompetitiveness = (MinorCivCompetitiveness + 2), VictoryCompetitiveness = (VictoryCompetitiveness + 5), Boldness = (Boldness + 3)
WHERE Type = NEW.Type;
END;
