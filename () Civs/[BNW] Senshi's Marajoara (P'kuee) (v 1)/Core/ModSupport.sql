...
) WHERE CivilizationType = "CIVILIZATION_SENSHI_MARAJO";
--==========================================================================================================================
-- MASTER TABLES
--==========================================================================================================================
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CIVILIZATION_SENSHI_MARAJO',	'Cordiform',		18,	16),
		('CIVILIZATION_SENSHI_MARAJO',	'GreatestEarth',	29,	21),
		('CIVILIZATION_SENSHI_MARAJO',	'Yagem',			165,	35),
		('CIVILIZATION_SENSHI_MARAJO',	'Yahem',			40,	32),
		('CIVILIZATION_SENSHI_MARAJO',	'EarthMk3',			163,	36),
		('CIVILIZATION_SENSHI_MARAJO',	'Americas',			56,	32),
		('CIVILIZATION_SENSHI_MARAJO',	'AmericasGiant',	107, 69),
		('CIVILIZATION_SENSHI_MARAJO',	'AtlanticGiant',	64,	25),
		('CIVILIZATION_SENSHI_MARAJO',	'SouthAmericaCentralGiant',	99, 99),
		('CIVILIZATION_SENSHI_MARAJO',	'SouthAmericaCentralHuge',		77,	74),
		('CIVILIZATION_SENSHI_MARAJO',	'SouthAmericaGiant',		86,	18),
		('CIVILIZATION_SENSHI_MARAJO',	'SouthAmericaLarge',		62,	72);
--------------------------------------------------------------------------------------------------------------------------
-- Civilizations_YagemRequestedResource
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType, 					MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT	'CIVILIZATION_SENSHI_MARAJO',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
VALUES	('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_DECOLONIZATION',		 4),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_MERCENARY',				 2),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 5),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 8), --Scale of Liberal to Authoritarian.
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_LEGAL',			 8), 	
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_CULTURE',		 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_ECONOMIC',		 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_FOREIGN',		 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_INDUSTRY',		 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_MILITARY',		 4),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_REFORM_RELIGION',		 8),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_SLAVERY',				 3),
		('LEADER_SENSHI_MARAJO',	'FLAVOR_JFD_STATE_RELIGION',		 4);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_SENSHI_MARAJO',	ArtDefineTag, 'CULTURE_JFD_KATUJE',	null, 'JFD_Katuje', 'JFD_Katuje', 'JFD_Katuje', 'JFD_Katuje', 'AS2D_SOUND_JFD_TUPI'
