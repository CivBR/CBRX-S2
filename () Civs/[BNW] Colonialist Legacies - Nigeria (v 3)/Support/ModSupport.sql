...
VALUES          ('CIVILIZATION_CL_NIGERIA',               'RELIGION_PROTESTANTISM');
 
UPDATE Civilization_Religions SET ReligionType =
        ( CASE WHEN EXISTS(SELECT TYPE FROM Religions WHERE TYPE="RELIGION_ITAN" )
                THEN "RELIGION_ITAN"
                ELSE "RELIGION_PROTESTANTISM" END
        ) WHERE CivilizationType = "CIVILIZATION_CL_NIGERIA";
 
CREATE TRIGGER ColonialistLegaciesNigeriaReligion
AFTER INSERT ON Religions WHEN 'RELIGION_ITAN' = NEW.TYPE
BEGIN
        UPDATE Civilization_Religions
        SET ReligionType = 'RELIGION_ITAN'
