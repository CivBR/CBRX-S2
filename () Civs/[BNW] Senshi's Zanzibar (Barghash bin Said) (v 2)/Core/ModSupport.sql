...
VALUES	('CIVILIZATION_SENSHI_ZANZIBAR',	'Cordiform',		44,	8),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'GreatestEarth',	65,	16),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'Yagem',			38,	24),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'Yahem',			74,	28),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'EarthMk3',			41,	23),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'AfriAsiaAust',		47,	32),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'AfriGiant',		107, 54),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'AfriSouthEuro',	55,	24),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'SouthernAfrica',	113, 100),
		('CIVILIZATION_SENSHI_ZANZIBAR',	'IndianOcean',		12,	32);
--------------------------------------------------------------------------------------------------------------------------
-- Civilizations_YagemRequestedResource
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType, 					MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT	'CIVILIZATION_SENSHI_ZANZIBAR',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO JFD_Civilopedia_HideFromPedia
		(Type)
VALUES	('BUILDING_SENSHI_ZANZIBAR_GOLDEN_AGE'),
		('BUILDING_SENSHI_ZANZIBAR_GREAT_WORKS');
--------------------------------------------------------------------------------------------------------------------------
-- LEADER FLAVOURS
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_DECOLONIZATION',		 0),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_MERCENARY',				 7),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 3),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 8), --Scale of Liberal to Authoritarian.
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_LEGAL',			 6), 	
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_CULTURE',		 5),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_ECONOMIC',		 6),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 7),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_FOREIGN',		 2),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_INDUSTRY',		 5),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_MILITARY',		 4),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_REFORM_RELIGION',		 6),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_SLAVERY',				 7),
		('LEADER_SENSHI_BARGHASH',	'FLAVOR_JFD_STATE_RELIGION',		 6);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_SENSHI_ZANZIBAR',	ArtDefineTag, CultureType,	SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
