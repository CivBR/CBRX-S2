...
VALUES          ('CIVILIZATION_DENEFIRSTNATION',            'RELIGION_PROTESTANTISM');
...
CREATE TRIGGER ColonialistLegaciesDeneReligion
AFTER INSERT ON Religions WHEN 'RELIGION_SGAANAANG' = NEW.TYPE
BEGIN
        UPDATE Civilization_Religions
        SET ReligionType = 'RELIGION_SGAANAANG'
        WHERE CivilizationType IN ('CIVILIZATION_DENEFIRSTNATION');
END;