...
VALUES	('LEADER_EW_TSOUHARISSEN',	'MAJOR_CIV_APPROACH_WAR',		6),
		('LEADER_EW_TSOUHARISSEN',	'MAJOR_CIV_APPROACH_HOSTILE',	6),
...
VALUES	('LEADER_EW_TSOUHARISSEN',	'FLAVOR_OFFENSE',				7),
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_DEFENSE',				6),
		...
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_RANGED',				5),
		...
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_EXPANSION',				6),
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_GROWTH',				4),
		...
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_GOLD',					4),
		...
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_RELIGION',				4),
		('LEADER_EW_TSOUHARISSEN',	'FLAVOR_DIPLOMACY',				5),
