...
WHERE Type = 'CIVILIZATION_DMS_BURKINA_FASO'
...
VALUES	('CIVILIZATION_DMS_BURKINA_FASO',	'Cordiform',		32,	15),
		('CIVILIZATION_DMS_BURKINA_FASO',	'GreatestEarth',	44,	25),
		('CIVILIZATION_DMS_BURKINA_FASO',	'Yagem',			12,	37),
		('CIVILIZATION_DMS_BURKINA_FASO',	'Yahem',			58,	38),
		('CIVILIZATION_DMS_BURKINA_FASO',	'AfricaLarge',		16,	47),
		('CIVILIZATION_DMS_BURKINA_FASO',	'AfriAsiaAust',		16,	46),
		('CIVILIZATION_DMS_BURKINA_FASO',	'AfriGiant',		33,	93),
		('CIVILIZATION_DMS_BURKINA_FASO',	'AfriSouthEuro',	25,	43),
		('CIVILIZATION_DMS_BURKINA_FASO',	'WestAfrica',		50,	30);
--------------------------------------------------------------------------------------------------------------------------
-- Civilizations_YagemRequestedResource
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType, 					MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4)
SELECT	'CIVILIZATION_DMS_BURKINA_FASO',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO JFD_Civilopedia_HideFromPedia
		(Type)
VALUES	('BUILDING_DMS_THE_UPRIGHT_MAN_EXTRA_PRODUCTION'),
		('BUILDING_DMS_FREIGHT_STATION_GOLD');
--------------------------------------------------------------------------------------------------------------------------
-- LEADER FLAVOURS
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_DECOLONIZATION',		 7),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_MERCENARY',				 5),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 0),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 6), --Scale of Liberal to Authoritarian.
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_LEGAL',			 5), 	
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_CULTURE',		 2),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_ECONOMIC',		 3),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 4),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_FOREIGN',		 6),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_INDUSTRY',		 4),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_MILITARY',		 6),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_REFORM_RELIGION',		 3),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_SLAVERY',				 0),
		('LEADER_DMS_THOMAS_SANKARA',	'FLAVOR_JFD_STATE_RELIGION',		 3);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_BURKINA_FASO',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, 'AS2D_SOUND_JFD_FRENCH'
