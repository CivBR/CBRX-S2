...
local iChola = GameInfo.Civilizations["CIVILIZATION_MC_CHOLA"].ID
local tCholaGold = {}
local tCholaAdmiral = {}
...
function CholaGoldTipHandler( control )
    ...
    if iCholaGoldBoost > 0 then
        strText = strText .. "[NEWLINE]  [ICON_BULLET]" .. Locale.ConvertTextKey("TXT_KEY_TP_MC_CHOLA_GOLD", iCholaGoldBoost)
    end
