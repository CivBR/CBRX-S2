...
-- MOD CHECKS
-------------------------------------------------------------------------------------------------------------------------
-- JFD_IsUsing_RiseToPower
function JFD_IsUsing_RiseToPower()
	local _RiseToPowerModID = "eea66053-7579-481a-bb8d-2f3959b59974"
	for _, mod in pairs(Modding.GetActivatedMods()) do
		if (mod.ID == _RiseToPowerModID) then
			return true
		end
	end
	return false
end
local bIsUsing_RiseToPower = JFD_IsUsing_RiseToPower()
-------------------------------------------------------------------------------------------------------------------------
-- GetReligion
-------------------------------------------------------------------------------------------------------------------------
...
local iCivType = GameInfoTypes["CIVILIZATION_MC_MAURYA"]
...
function MauryaUA (pPlayer)
	if load(pPlayer, "bBonusEnabled") == true then
		...
		local iReligion = GetReligion(pPlayer)
		--print(iReligion)
