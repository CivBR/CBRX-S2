...
local BAdmiralPromotion = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_0"].ID
local BGLevel1 = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_1"].ID
local BGLevel2 = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_2"].ID
local BGLevel3 = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_3"].ID
local BGLevel4 = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_4"].ID
local BGLevel4 = GameInfo.UnitPromotions["PROMOTION_MC_BATTLE_ADMIRAL_5"].ID
