...
VALUES	('SND_SOUND_JFD_GENERIC_CHOICE', 							'GenericChoice',						'DynamicResident'),
		...
		('SND_WONDER_SPEECH_JFD_BUDA_CASTLE',						'Wonder_BudaCastle',					'DynamicResident'),
		...
		('SND_WONDER_SPEECH_JFD_MESA_VERDE',						'Wonder_MesaVerde',						'DynamicResident'),
		('SND_WONDER_SPEECH_JFD_MOSQUE_DAMASCUS',					'Wonder_MosqueDamascus',				'DynamicResident'),
		('SND_WONDER_SPEECH_JFD_MOTHERLAND_CALLS',					'Wonder_MotherlandCalls',				'DynamicResident'),
		('SND_WONDER_SPEECH_JFD_POTALA_PALACE',						'Wonder_PotalaPalace',					'DynamicResident'),
		...
		('SND_WONDER_SPEECH_JFD_VALLEY_OF_THE_FALLEN',				'Wonder_ValleyOfTheFallen',				'DynamicResident'),
...
VALUES	('AS2D_SOUND_JFD_GENERIC_CHOICE', 							'SND_SOUND_JFD_GENERIC_CHOICE', 							'GAME_SFX',  0,		    1,						1,					-1.0,					100, 		100),			
		...
		('AS2D_WONDER_SPEECH_JFD_ABU_SIMBEL',						'SND_WONDER_SPEECH_JFD_ABU_SIMBEL',							'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		...
		('AS2D_WONDER_SPEECH_JFD_BUDA_CASTLE',						'SND_WONDER_SPEECH_JFD_BUDA_CASTLE',						'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		...
		('AS2D_WONDER_SPEECH_JFD_MESA_VERDE',						'SND_WONDER_SPEECH_JFD_MESA_VERDE',							'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		('AS2D_WONDER_SPEECH_JFD_MOSQUE_DAMASCUS',					'SND_WONDER_SPEECH_JFD_MOSQUE_DAMASCUS',					'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		('AS2D_WONDER_SPEECH_JFD_MOTHERLAND_CALLS',					'SND_WONDER_SPEECH_JFD_MOTHERLAND_CALLS',					'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		('AS2D_WONDER_SPEECH_JFD_POTALA_PALACE',					'SND_WONDER_SPEECH_JFD_POTALA_PALACE',						'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
		...
		('AS2D_WONDER_SPEECH_JFD_VALLEY_OF_THE_FALLEN',				'SND_WONDER_SPEECH_JFD_VALLEY_OF_THE_FALLEN',				'GAME_SFX',  0,			1,						1,					0.0,					75, 		75),		
