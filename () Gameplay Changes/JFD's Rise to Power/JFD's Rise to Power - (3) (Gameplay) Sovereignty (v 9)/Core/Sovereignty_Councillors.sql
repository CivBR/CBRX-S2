...
VALUES	('POLICY_COUNCILLOR_JFD_CHANCELLOR_GREAT_ENGINEER',		'REFORM_BRANCH_JFD_INDUSTRY',	-10),
		('POLICY_COUNCILLOR_JFD_CHAPLAIN_GREAT_PROPHET',		'REFORM_BRANCH_JFD_RELIGION',	-10),
		('POLICY_COUNCILLOR_JFD_HERALD_GREAT_ARTIST',			'REFORM_BRANCH_JFD_SOCIAL',		-10),
		('POLICY_COUNCILLOR_JFD_HERALD_GREAT_MUSICIAN',			'REFORM_BRANCH_JFD_SOCIAL',		-10),
		('POLICY_COUNCILLOR_JFD_HERALD_GREAT_WRITER',			'REFORM_BRANCH_JFD_SOCIAL',		-10),
		('POLICY_COUNCILLOR_JFD_MARSHAL_GREAT_ADMIRAL',			'REFORM_BRANCH_JFD_DIPLOMACY',	-10),
		('POLICY_COUNCILLOR_JFD_MARSHAL_GREAT_GENERAL',			'REFORM_BRANCH_JFD_MILITARY',	-10),
		('POLICY_COUNCILLOR_JFD_STEWARD_GREAT_MERCHANT',		'REFORM_BRANCH_JFD_ECONOMY',	-10),
		('POLICY_COUNCILLOR_JFD_STEWARD_GREAT_SCIENTIST',		'REFORM_BRANCH_JFD_EDUCATION',	-10);
--==========================================================================================================================
--==========================================================================================================================
