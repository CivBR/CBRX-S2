...
-------------------------------------------------------------------------------
-- JFD
local ideologicalValueAuthorityID = GameInfoTypes["IDEOLOGICAL_VALUE_JFD_AUTHORITY"]
local ideologicalValueEqualityID  = GameInfoTypes["IDEOLOGICAL_VALUE_JFD_EQUALITY"]
local ideologicalValueLibertyID   = GameInfoTypes["IDEOLOGICAL_VALUE_JFD_LIBERTY"]
-- JFD
...
function RefreshList()
	...
	local ideologies = {
		{
			...
			ImageOffsetY = 0,
			-- JFD
			IdeologicalValueID = ideologicalValueEqualityID,
			-- JFD
		},		
		{
			...
			ImageOffsetY = 20,
			-- JFD
			IdeologicalValueID = ideologicalValueAuthorityID,
			-- JFD
		},
		{
			...
			ImageOffsetY = 0,
			-- JFD
			IdeologicalValueID = ideologicalValueLibertyID,
			-- JFD
		},	
	}	
	...
	for _, ideology in ipairs(ideologies) do
			...
			local pPreferredIdeologicalValue = GameInfo.JFD_IdeologicalValues[ideology.IdeologicalValueID]
...
function ViewTenets(branchType)
	...
	function PopulateInstance(instance, row, text)
		...
		-- JFD
		local ideologicalValue = row.IdeologicalValueType
		local ideologicalValueReq = row.IdeologicalValueReq
		local hasIdeologicalValuesForTenet = Players[Game.GetActivePlayer()]:HasIdeologicalValuesForTenet(row.ID)
